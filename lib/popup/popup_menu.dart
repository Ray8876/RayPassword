...
typedef MenuClickCallback = Function(MenuItemProvider item, dynamic exData);
...
class PopupMenu {
  ...
  void show({Rect rect, GlobalKey widgetKey, List<MenuItemProvider> items,dynamic data}) {
    if(data != null) exData = data;
...
//        },
  ...
  void itemClicked(MenuItemProvider item,dynamic exData) {
    if (onClickMenu != null) {
      onClickMenu(item,exData);
    }
...
class _MenuItemWidget extends StatefulWidget {
  ...
  final Function(MenuItemProvider item,dynamic exData) clickCallback;
    ...
    return GestureDetector(
      ...
      onTap: () {
        if (widget.clickCallback != null) {
          widget.clickCallback(widget.item,widget.exData);
        }
      },
      child: Container(
